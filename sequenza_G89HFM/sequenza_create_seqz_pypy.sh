...
SEQZ_DIR="/share/ScratchGeneral/julyin/G89/sequenza_normal_vs_pdx_pypy/seqz_large_files"

BINNED_SEQZ_DIR="/share/ScratchGeneral/julyin/G89/sequenza_normal_vs_pdx_pypy/bigger_binned_seqz"
...
$PYPY ${SEQ_UTILS}/sequenza-utils.py bam2seqz -n ${NORMAL_DIR}/$NORM.dedup.realn.bam -t ${TUMOUR_DIR}/$TUM.dedup.realn.bam -F $HUMAN_REF -gc $GC_FILE -C chr$CHR | \
