...
DIR="/home/julyin/genome_gbm_variant_calling/manta/xenograft_G89/circos/control_vs_patient"

OUT_PARSER=$DIR/G89control.vs.G89HFMTissueDNA.manta.circos.raw.txt
