...
for file_path in file_name_list:
    ...
    with open('/home/julyin/genome_gbm_variant_calling/strelka-snvs-indels/strelka-G89controlDNA-vs-G89HFMTissueDNA/myAnalysis/results/passed.somatic.snvs.vcf') as in_vcf, open(file_path + '.chr_filt.vcf', "w") as out_vcf:
        for line in in_vcf:
