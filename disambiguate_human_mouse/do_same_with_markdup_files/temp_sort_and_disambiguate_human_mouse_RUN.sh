...
SNAKEMAKE_FILE="temp_sort_and_disambiguate_human_mouse.snakemake"
...
snakemake -s $SNAKEMAKE_FILE --drmaa " -q all.q -cwd -V -b y -j y -pe smp {params.cores} -l {params.hvmem} -l {params.memrequested} -N {params.jobname} -P {params.account}" -j 100
